...
const WelcomePage = ({ auth, laravelVersion, phpVersion }) => {
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
          <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
              ...
              <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                    ...
                    >
                      ...
                      <div className="pt-3 sm:pt-5 lg:pt-0">
                        ...
                        <p className="mt-4 text-sm/relaxed">
                          Officia sint aute sint aliquip ea non cillum aliquip
                          cillum cupidatat ad aliqua.
                        </p>
                      </div>
                    </div>
                ...
                >
                  ...
                  <div className="pt-3 sm:pt-5">
                    ...
                    <p className="mt-4 text-sm/relaxed">
                      Veniam ex pariatur sint incididunt labore dolor ullamco
                      nostrud ea. Quis voluptate quis irure fugiat et proident
                      ipsum culpa ipsum cupidatat sit.
                    </p>
                  </div>
                ...
                >
                  ...
                  <div className="pt-3 sm:pt-5">
                    ...
                    <p className="mt-4 text-sm/relaxed">
                      Pariatur proident ea minim labore minim excepteur aute
                      incididunt labore culpa. Laborum cillum esse fugiat do est
                      non proident duis do.
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                  ...
                  <div className="pt-3 sm:pt-5">
                    ...
                    <p className="mt-4 text-sm/relaxed">
                      Aliqua nulla cillum cupidatat aliquip pariatur officia
                      proident sint aliquip elit voluptate voluptate..
                    </p>
                  </div>
                </div>
              </div>
            ...
            <footer className="py-16 text-center text-sm text-black dark:text-white/70">
              Electronic Document Management v{laravelVersion} (PHP v
              {phpVersion})
            </footer>
          </div>
        </div>
